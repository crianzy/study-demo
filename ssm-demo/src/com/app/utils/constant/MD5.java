...
/**
 * Class: MD5.java Description: MD5加密和解密
 * 
 * @author caiqf
 * @date 2012-6-13
 */
...
public final class MD5 {
	...
	private static final short MD5BITS = 16; // 8=16bits 16=32bits
	private long state[];
	private long count[];
	private byte buffer[];
	private byte digest[];
	...
	/**
	 * @author caiqf
	 * @date 2012-6-13 上午10:16:29
	 * @describe 获得加密后的结果，16位
	 * @param str
	 * @return String
	 * @exception
	 * @version 1.0
	 */
	public synchronized String get16BitMD5(String str) {
		String str32 = getMD5(str);
		return str32.substring(8, 24);
	}

	/**
	 * @author caiqifan
	 * @date 2012-6-13 下午05:27:21
	 * @describe 获取MD5加密后的结果，N位
	 * @return String
	 * @exception
	 * @version 1.0
	 */
	public synchronized String getNBitMD5(String str, int n) {
		String str32 = getMD5(str);
		return str32.substring(0, n);
	}
	...
	public static void main(String[] args) {
		...
		try {
			testString = new String(testString.getBytes("UTF8"), "UTF-8");
			// System.out.println(md5.getMD5(new
			// String(testString.getBytes("ISO-8859-1"), "gb2312")));
			System.out.println(md5.getMD5(new String(testString
			...
			System.out.println(md5.getMD5(new String(
					testString.getBytes("GBK"), "UTF-8")));
			// System.out.println(md5.getMD5(new
